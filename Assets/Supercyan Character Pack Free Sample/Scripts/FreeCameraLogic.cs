...
namespace Supercyan.FreeSample
{
    public class FreeCameraLogic : MonoBehaviour
    {
        ...
        {
            return obj is FreeCameraLogic logic &&
                   base.Equals(obj) &&
                   EqualityComparer<List<Transform>>.Default.Equals(m_targets, logic.m_targets);
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hash = (hash * 397) ^ (m_targets != null ? EqualityComparer<List<Transform>>.Default.GetHashCode(m_targets) : 0);
                return hash;
            }
        }
    }
